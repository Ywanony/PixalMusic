...
# All rights reserved.
#
# Ultra-Luxury Re-Aligned Dynamic Thumbnail Engine.
# White Background Completely Replaced With Fluid Image & Right Font Adjustment.
...
async def gen_thumb(videoid: str):
    ...
    try:
        # --- STAGE 1: CINEMATIC BLURRY BLACK GRADIENT BACKGROUND ---
        ...
        bg_graded = ImageEnhance.Brightness(bg_graded).enhance(0.40)
        ...
        # --- STAGE 3: THE FIXED THUMBNAIL (Fills the entire rounded box place) ---
        ...
        # Sleek inner border rim profile around the thumbnail block
        ...
        # --- STAGE 5: ADJUSTED FONTS POSITIONING ---
        # Fonts are perfectly aligned right inside the dynamic thumbnail overlay grid
        draw = ImageDraw.Draw(canvas)
        info_x = card_x + (card_w // 2) - 30  
        ...
        brand_y = card_y + 85
        draw.text((info_x, brand_y), brand_text, fill=(56, 189, 248, 230), font=brand_font) 
        ...
        # Dual-layer drop shadows for crystal clear visibility on any backdrop image
